---
title: Mining & Time Control
description: 'Control block production and manipulate time with mine(), automine, intervalMining, increaseTime, and setNextBlockTimestamp.'
---
...
void testVestingUnlock() {
    ...
    try {
        ...
        Address beneficiary = Address.from("0x...");
...
void testAuctionDeadline() {
    ...
    try {
        ...
        TransactionReceipt bid1 = placeBid(Wei.fromEther("1"));
        ...
        assertThrows(RevertException.class, () -> placeBid(Wei.fromEther("2")));
