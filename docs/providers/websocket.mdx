...
<Tip>
For **type-safe subscriptions**, use [`client.onNewHeads()`](/brane-reader/subscriptions) and [`client.onLogs()`](/brane-reader/subscriptions) instead of the raw provider API shown below.
</Tip>
