...
For real-time subscriptions and lower latency, use `WebSocketProvider`.
...
<Card title="WebSocket Guide" icon="bolt" href="/providers/websocket">
  Learn about subscriptions, batching, and advanced WebSocket features.
</Card>
