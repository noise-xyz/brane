...
The HTTP provider is the default transport for most use cases. Brane uses Java 21's virtual threads for efficient concurrent I/O.
...
```java
import io.brane.core.exceptions.RpcException;
