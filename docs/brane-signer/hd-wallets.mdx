---
title: HD Wallets
description: 'Generate and manage hierarchical deterministic wallets with BIP-39 mnemonic phrases.'
---
...
DerivationPath path2 = DerivationPath.of(1, 0);

// m/44'/60'/2'/0/3 - Address index 3 of account 2
DerivationPath path3 = DerivationPath.of(2, 3);
...
// Send transaction
var receipt = client.sendTransactionAndWait(TransactionRequest.builder()
    .to(recipient)
...
public class HdWalletExample {
    public static void main(String[] args) {
        ...
        try {
            ...
            Signer tradingAccount = wallet.derive(DerivationPath.of(2, 0));
...
| `of(int account, int addressIndex)` | Create path with custom account |
