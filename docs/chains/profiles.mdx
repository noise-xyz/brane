...
var provider = HttpBraneProvider.builder("https://eth-mainnet.g.alchemy.com/v2/YOUR-API-KEY").build();
...
var provider = HttpBraneProvider.builder("https://arb1.arbitrum.io/rpc").build();
var client = PublicClient.from(provider);
```
...
var provider = HttpBraneProvider.builder("https://...").build();
var publicClient = PublicClient.from(provider);

// WalletClient uses provider + publicClient + signer + chain
