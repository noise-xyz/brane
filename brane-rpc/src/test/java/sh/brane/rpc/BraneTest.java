...
class BraneTest {
    ...
    void builderWithChainProfilePropagates() {
        ...
        sh.brane.core.chain.ChainProfile chainProfile = sh.brane.core.chain.ChainProfiles.ETH_MAINNET;
        Brane.Reader reader = Brane.builder()
                .provider(provider)
                .chain(chainProfile)
                .buildReader();
    ...
    void testerGetBalanceDelegatesCorrectly() {
        ...
        sh.brane.core.types.Address address = new sh.brane.core.types.Address("0x0000000000000000000000000000000000000001");
    ...
    void testerGetLatestBlockDelegatesCorrectly() {
        ...
        sh.brane.core.model.BlockHeader block = tester.getLatestBlock();
        assertNotNull(block);
    ...
    void testerCallDelegatesCorrectly() {
        ...
        sh.brane.core.types.Address contractAddress = new sh.brane.core.types.Address("0x0000000000000000000000000000000000000001");
        CallRequest request = CallRequest.builder()
                .to(contractAddress)
                .data(new sh.brane.core.types.HexData("0x"))
                .build();

        sh.brane.core.types.HexData result = tester.call(request);
    ...
    void testerGetLogsDelegatesCorrectly() {
        ...
        java.util.List<sh.brane.core.model.LogEntry> logs = tester.getLogs(filter);
        assertNotNull(logs);
    ...
    void testerEstimateGasDelegatesCorrectly() {
        ...
        sh.brane.core.types.Address from = new sh.brane.core.types.Address("0x0000000000000000000000000000000000000001");
        sh.brane.core.types.Address to = new sh.brane.core.types.Address("0x0000000000000000000000000000000000000002");
        sh.brane.core.model.TransactionRequest request = sh.brane.core.builder.TxBuilder.eip1559()
                .from(from)
                .to(to)
                .build();
