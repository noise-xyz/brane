...
class TesterIntegrationTest {
    ...
    class ImpersonationTests {
        ...
        void impersonateSendsTransactionFromImpersonatedAddress(Brane.Tester tester) {
            ...
            try (ImpersonationSession session = tester.impersonate(WHALE_ADDRESS)) {
                sh.brane.core.model.TransactionRequest request = new sh.brane.core.model.TransactionRequest(
                ...
                sh.brane.core.model.TransactionReceipt receipt = tester.waitForReceipt(txHash);
        ...
        void impersonateSendTransactionAndWaitWorks(Brane.Tester tester) {
            ...
            try (ImpersonationSession session = tester.impersonate(WHALE_ADDRESS)) {
                ...
                sh.brane.core.model.TransactionReceipt receipt = session.sendTransactionAndWait(request);
        ...
        void impersonateCanSendMultipleTransactions(Brane.Tester tester) {
            ...
            try (ImpersonationSession session = tester.impersonate(WHALE_ADDRESS)) {
                // First transaction
                sh.brane.core.model.TransactionRequest request1 = new sh.brane.core.model.TransactionRequest(
                        null, recipient1, Wei.fromEther(java.math.BigDecimal.ONE),
                        21_000L, null, null, null, null, null, false, null);
                sh.brane.core.model.TransactionReceipt receipt1 = session.sendTransactionAndWait(request1);
                assertTrue(receipt1.status());

                // Second transaction
                sh.brane.core.model.TransactionRequest request2 = new sh.brane.core.model.TransactionRequest(
                        null, recipient2, Wei.fromEther(java.math.BigDecimal.ONE),
                        21_000L, null, null, null, null, null, false, null);
                sh.brane.core.model.TransactionReceipt receipt2 = session.sendTransactionAndWait(request2);
    ...
    class MiningTests {
        ...
        void mineAdvancesBlockNumberByOne(Brane.Tester tester) {
            sh.brane.core.model.BlockHeader beforeBlock = tester.getLatestBlock();
            long beforeNumber = beforeBlock.number();

            tester.mine();

            sh.brane.core.model.BlockHeader afterBlock = tester.getLatestBlock();
    ...
    class AutomineTests {
        ...
        void transactionsNotMinedWhenAutomineDisabled(Brane.Tester tester) {
            ...
            sh.brane.core.model.BlockHeader finalBlock = tester.getLatestBlock();
    ...
    class TimeManipulationTests {
        ...
        void setNextBlockTimestampOnlyAffectsNextBlock(Brane.Tester tester) {
            ...
            sh.brane.core.model.BlockHeader currentBlock = tester.getLatestBlock();
            ...
            tester.mine();
            sh.brane.core.model.BlockHeader firstBlock = tester.getLatestBlock();
            ...
            tester.mine();
            sh.brane.core.model.BlockHeader secondBlock = tester.getLatestBlock();
        ...
        void timeManipulationPreservedAcrossSnapshots(Brane.Tester tester) {
            ...
            sh.brane.core.model.BlockHeader initialBlock = tester.getLatestBlock();
            ...
            sh.brane.core.model.BlockHeader advancedBlock = tester.getLatestBlock();
            ...
            tester.mine();
            sh.brane.core.model.BlockHeader revertedBlock = tester.getLatestBlock();
    ...
    class ResetTests {
        ...
        void resetResetsBlockNumberToGenesis(Brane.Tester tester) {
            ...
            sh.brane.core.model.BlockHeader blockBeforeReset = tester.getLatestBlock();
            ...
            sh.brane.core.model.BlockHeader blockAfterReset = tester.getLatestBlock();
        ...
        void resetWithForkUrlSetsUpForkedState(Brane.Tester tester) {
            ...
            sh.brane.core.model.BlockHeader blockAfterFork = tester.getLatestBlock();
