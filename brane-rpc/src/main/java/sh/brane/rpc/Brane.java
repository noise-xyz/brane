 ...
 * <ul>
 *   <li>{@link sh.brane.core.error.RpcException} - JSON-RPC communication failures</li>
 *   <li>{@link sh.brane.core.error.RevertException} - EVM execution reverts (for calls)</li>
 ...
 * <ul>
 *   <li>{@link sh.brane.core.error.TxnException} - Transaction-specific failures</li>
 * </ul>
 *
 * @see Brane.Reader
 * @see Brane.Signer
...
public sealed interface Brane extends AutoCloseable permits Brane.Reader, Brane.Signer, Brane.Tester {
     ...
     * @since 0.1.0
     */
    static Signer connect(String rpcUrl, sh.brane.core.crypto.Signer signer) {
     ...
     * @since 0.3.0
     */
    static Tester connectTest(sh.brane.core.crypto.Signer signer) {
     ...
     * @since 0.3.0
     */
    static Tester connectTest(String rpcUrl, sh.brane.core.crypto.Signer signer) {
     ...
     * @since 0.3.0
     */
    static Tester connectTest(String rpcUrl, sh.brane.core.crypto.Signer signer, TestNodeMode mode) {
     ...
     * {@link sh.brane.core.crypto.PrivateKey}) that can sign transactions. The signing
     ...
     * @see Brane
     * @see Brane.Reader
     * @see sh.brane.core.crypto.Signer
     * @see sh.brane.core.crypto.PrivateKey
     * @since 0.1.0
     */
    sealed interface Signer extends Brane permits DefaultSigner {
        ...
        default TransactionReceipt sendBlobTransactionAndWait(
            ...
            while (System.nanoTime() - deadlineNanos < 0) {
                ...
                if (receipt != null) {
                    if (!receipt.status()) {
                        throw new sh.brane.core.error.RevertException(
                                sh.brane.core.RevertDecoder.RevertKind.UNKNOWN,
                ...
                try {
                    ...
                    throw new sh.brane.core.error.RpcException(
         ...
         * @since 0.1.0
         */
        sh.brane.core.crypto.Signer signer();
    }
    ...
    sealed interface Tester extends Brane permits DefaultTester {
         ...
         * @since 0.2.0
         */
        void setBalance(Address address, sh.brane.core.types.Wei balance);
         ...
         * @since 0.2.0
         */
        void setNextBlockBaseFee(sh.brane.core.types.Wei baseFee);
         ...
         * @throws sh.brane.core.error.RpcException if timeout is reached or interrupted
         * @since 0.2.0
         */
     ...
     *   <tr><td>{@link #signer(sh.brane.core.crypto.Signer)}</td><td>Transaction signer</td><td>Yes for Signer client</td></tr>
    ...
    final class Builder {
        ...
        private sh.brane.core.crypto.@Nullable Signer signer;
         ...
         * @since 0.1.0
         */
        public Builder signer(sh.brane.core.crypto.Signer signer) {
            this.signer = signer;
            return this;
        }
         ...
         * @return this builder for chaining
         * @since 0.1.0
         * @see sh.brane.core.chain.ChainProfiles
         */
         ...
         * <ul>
         *   <li>A {@link Brane.Signer} if a signer was configured via {@link #signer(sh.brane.core.crypto.Signer)}</li>
        ...
        public Signer buildSigner() {
            validateProviderConfig();
            final sh.brane.core.crypto.Signer resolvedSigner = signer;
