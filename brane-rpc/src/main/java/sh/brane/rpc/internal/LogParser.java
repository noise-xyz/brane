 ...
 * <p>
 * This class consolidates log parsing logic used by both {@link sh.brane.rpc.Brane.Reader} (eth_getLogs)
 * and {@link sh.brane.rpc.Brane.Signer} (transaction receipt logs).
 * <p>
...
public final class LogParser {
     ...
     * @return list of parsed LogEntry objects
     * @throws sh.brane.core.error.AbiDecodingException if requireLogIndex is true and logIndex is missing
     */
     ...
     * {@link sh.brane.core.error.AbiDecodingException} is thrown rather than RpcException.
     *
     ...
     * @return parsed LogEntry
     * @throws NullPointerException if address or transactionHash is null
     * @throws sh.brane.core.error.AbiDecodingException if logIndex is missing (malformed response)
     */
    public static LogEntry parseLogStrict(final Map<String, Object> map) {
        ...
        if (rawLogIndex == null) {
            throw new sh.brane.core.error.AbiDecodingException(
