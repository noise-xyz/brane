...
<img src="/images/architecture-overview.svg" alt="Architecture Overview" className="architecture-diagram architecture-overview" />
...
<img src="/images/module-dependencies.svg" alt="Module Dependencies" className="architecture-diagram module-dependencies" />
