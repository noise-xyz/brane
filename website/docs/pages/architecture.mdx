...
<img src="/images/architecture-overview.svg" alt="Architecture Overview" style={{ maxWidth: '600px', margin: '2rem auto', display: 'block' }} />
...
<img src="/images/module-dependencies.svg" alt="Module Dependencies" style={{ maxWidth: '400px', margin: '2rem auto', display: 'block' }} />
