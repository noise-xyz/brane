...
:::tip
For **type-safe subscriptions**, use [`client.onNewHeads()`](/reader/subscriptions) and [`client.onLogs()`](/reader/subscriptions) instead of the raw provider API shown below.
:::
