...
HD wallets follow BIP-39 for mnemonic phrases and BIP-44 for Ethereum key derivation. For comprehensive documentation including passphrases, custom derivation paths, and security best practices, see [HD Wallets](/signer/hd-wallets).
...
For comprehensive documentation on EIP-712 typed data signing, including type definitions, nested types, and JSON parsing for wallet integration, see [EIP-712 Typed Data](/signer/eip712).
