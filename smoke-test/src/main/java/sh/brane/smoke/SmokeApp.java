...
import sh.brane.core.RevertDecoder.CustomErrorAbi;
import sh.brane.core.RevertDecoder.Decoded;
...
public class SmokeApp {
    ...
    public record Eip712Permit(
        ...
        public static final sh.brane.core.crypto.eip712.TypeDefinition<Eip712Permit> DEFINITION =
                sh.brane.core.crypto.eip712.TypeDefinition.forRecord(
                        Eip712Permit.class,
                        "Permit",
                        Map.of("Permit", List.of(
                                sh.brane.core.crypto.eip712.TypedDataField.of("owner", "address"),
                                sh.brane.core.crypto.eip712.TypedDataField.of("spender", "address"),
                                sh.brane.core.crypto.eip712.TypedDataField.of("value", "uint256"),
                                sh.brane.core.crypto.eip712.TypedDataField.of("nonce", "uint256"),
                                sh.brane.core.crypto.eip712.TypedDataField.of("deadline", "uint256"))));
    }
    ...
    private static void testEip712TypeSafeSigning() {
        ...
        sh.brane.core.crypto.eip712.Eip712Domain domain = sh.brane.core.crypto.eip712.Eip712Domain.builder()
                .name("TestToken")
                .version("1")
                .chainId(31337L)
        ...
        sh.brane.core.crypto.eip712.TypedData<Eip712Permit> typedData =
                sh.brane.core.crypto.eip712.TypedData.create(domain, Eip712Permit.DEFINITION, permit);

        sh.brane.core.types.Hash hash = typedData.hash();
        ...
        Address recovered = sh.brane.core.crypto.PrivateKey.recoverAddress(hash.toBytes(), signature);
    ...
    private static void testEip712DynamicSigning() {
        ...
        var types = new java.util.LinkedHashMap<String, List<sh.brane.core.crypto.eip712.TypedDataField>>();
        ...
        sh.brane.core.types.Hash hash = sh.brane.core.crypto.eip712.TypedDataSigner.hashTypedData(
                domain, "Permit", types, message);
        System.out.println("  EIP-712 Hash: " + hash.value());

        Signature signature = sh.brane.core.crypto.eip712.TypedDataSigner.signTypedData(
    ...
    private static void testEip712JsonParsing() {
        ...
        sh.brane.core.crypto.eip712.TypedDataPayload payload =
                sh.brane.core.crypto.eip712.TypedDataJson.parse(permitJson);
        ...
        sh.brane.core.crypto.eip712.TypedData<?> typedData =
                sh.brane.core.crypto.eip712.TypedData.fromPayload(payload);
        ...
        sh.brane.core.crypto.eip712.TypedData<?> typedData2 =
                sh.brane.core.crypto.eip712.TypedDataJson.parseAndValidate(permitJson);
        sh.brane.core.types.Hash hash2 = typedData2.hash();
    ...
    private static void testTesterOperations() {
        ...
        try (Brane.Tester tester = Brane.connectTest(rpcUrl)) {
            ...
            sh.brane.rpc.SnapshotId snapshot = tester.snapshot();
            ...
            Address recipient = sh.brane.rpc.AnvilSigners.keyAt(1).address();
            ...
            try (sh.brane.rpc.ImpersonationSession session = tester.impersonate(whaleAddress)) {
