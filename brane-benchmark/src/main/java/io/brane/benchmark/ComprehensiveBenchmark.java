...
/**
 * Comprehensive benchmark comparing Brane NettyBraneProvider vs Web3j.
 * 
 * Tests:
...
public class ComprehensiveBenchmark {
    ...
    private static void runBenchmarkSuite(String url, String networkName, StringBuilder results) throws Exception {
        ...
        NettyBraneProvider brane = NettyBraneProvider.create(url);
    ...
    private static void warmup(NettyBraneProvider brane, Web3j web3j) throws Exception {
        // Warmup Brane
        for (int i = 0; i < 10; i++) {
    ...
    private static LatencyResult measureLatency(NettyBraneProvider provider) throws Exception {
    ...
    private static double measureBurstThroughput(NettyBraneProvider provider, int burstSize) throws Exception {
        long start = System.nanoTime();
    ...
    private static double measureSustainedThroughput(NettyBraneProvider provider) throws Exception {
