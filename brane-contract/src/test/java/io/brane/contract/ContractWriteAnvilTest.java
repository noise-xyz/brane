...
class ContractWriteAnvilTest {
  ...
  private static final String RPC_URL = System.getProperty("brane.anvil.rpc", "http://127.0.0.1:8545");
  private static final String CONTRACT_ADDRESS = System.getProperty(
      "brane.anvil.storage.address", "0x0000000000000000000000000000000000000000");
  private static final String PRIVATE_KEY = System.getProperty(
  ...
  void writeUpdatesState() throws RpcException, RevertException {
    ...
    final io.brane.core.crypto.Signer signer = new io.brane.core.crypto.PrivateKeySigner(PRIVATE_KEY);
