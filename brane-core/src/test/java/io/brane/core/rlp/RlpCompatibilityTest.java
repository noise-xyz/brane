...
class RlpCompatibilityTest {
    ...
    void emptyString_matchesWeb3j() {
        ...
        // web3j encoding
        io.brane.internal.web3j.rlp.RlpString web3jString = io.brane.internal.web3j.rlp.RlpString.create(new byte[0]);
    ...
    void shortString_matchesWeb3j() {
        ...
        io.brane.internal.web3j.rlp.RlpString web3jString = io.brane.internal.web3j.rlp.RlpString.create(dogBytes);
        byte[] web3jEncoding = io.brane.internal.web3j.rlp.RlpEncoder.encode(web3jString);
    ...
    void longString_matchesWeb3j() {
        ...
        io.brane.internal.web3j.rlp.RlpString web3jString = io.brane.internal.web3j.rlp.RlpString.create(longData);
        byte[] web3jEncoding = io.brane.internal.web3j.rlp.RlpEncoder.encode(web3jString);
    ...
    void emptyList_matchesWeb3j() {
        ...
        io.brane.internal.web3j.rlp.RlpList web3jList = new io.brane.internal.web3j.rlp.RlpList(
    ...
    void nestedList_matchesWeb3j() {
        ...
        io.brane.internal.web3j.rlp.RlpList web3jInnerList = new io.brane.internal.web3j.rlp.RlpList(
                java.util.Collections.emptyList());
        java.util.List<io.brane.internal.web3j.rlp.RlpType> web3jItems = java.util.Collections
                .singletonList(web3jInnerList);
        io.brane.internal.web3j.rlp.RlpList web3jOuterList = new io.brane.internal.web3j.rlp.RlpList(web3jItems);
    ...
    void integerEncoding_matchesWeb3j() {
        ...
        for (long value : testValues) {
            ...
            io.brane.internal.web3j.rlp.RlpString web3jString = io.brane.internal.web3j.rlp.RlpString
                    .create(valueBytes);
            byte[] web3jEncoding = io.brane.internal.web3j.rlp.RlpEncoder.encode(web3jString);
    ...
    void bigIntegerEncoding_matchesWeb3j() {
        ...
        BigInteger[] testValues = {
                ...
                new BigInteger("115792089237316195423570985008687907853269984665640564039457584007913129639935") // max
                                                                                                                 // uint256
        };
    ...
    void complexList_matchesWeb3j() {
        ...
        io.brane.internal.web3j.rlp.RlpList web3jOuterList = new io.brane.internal.web3j.rlp.RlpList(
                java.util.Arrays.asList(
    ...
    void roundTripDecoding_matchesWeb3j() {
        ...
        io.brane.internal.web3j.rlp.RlpString web3jString = io.brane.internal.web3j.rlp.RlpString.create(originalData);
