...
class AbiEncodingDecodingTest {
        ...
        void decodesSimpleOutputs() {
                ...
                // uint256(42)
                String uintRaw = sh.brane.primitives.Hex.encode(
                                AbiEncoder.encode(
                ...
                // bool(true)
                String boolRaw = sh.brane.primitives.Hex.encode(
                                AbiEncoder.encode(
                ...
                String addressRaw = sh.brane.primitives.Hex.encode(
                                AbiEncoder.encode(
                ...
                // string("hello")
                String stringRaw = sh.brane.primitives.Hex.encode(
                                AbiEncoder.encode(
