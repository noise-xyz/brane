 ...
 * <p>
 * <strong>Revert Types
 * ({@link sh.brane.core.RevertDecoder.RevertKind}):</strong>
 * <ul>
 ...
 * }</pre>
 *
 * @see sh.brane.core.RevertDecoder
 * @since 0.1.0-alpha
 */
public final class RevertException extends BraneException {

    private final sh.brane.core.RevertDecoder.RevertKind kind;
    ...
    public RevertException(
            final sh.brane.core.RevertDecoder.RevertKind kind,
    ...
    private static String messageFor(
        ...
        final String kindSuffix = kind != sh.brane.core.RevertDecoder.RevertKind.UNKNOWN
                ? " [" + kind + "]"
                : "";
        return reason != null
    ...
    public sh.brane.core.RevertDecoder.RevertKind kind() {
        return kind;
    }
