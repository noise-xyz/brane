...
public interface Abi {
     ...
     */
    static List<sh.brane.core.model.MulticallResult> decodeMulticallResults(String hex) {
     ...
     * @throws sh.brane.core.error.AbiEncodingException if the function is not found in the ABI,
     ...
     * @throws sh.brane.core.error.AbiEncodingException if the constructor is not defined but arguments
     ...
     * @throws sh.brane.core.error.AbiDecodingException if decoding fails or the event
     *         type cannot be instantiated (e.g., non-public constructor, module access denied)
     */
    <T> java.util.List<T> decodeEvents(String eventName, java.util.List<sh.brane.core.model.LogEntry> logs,
            Class<T> eventType);
