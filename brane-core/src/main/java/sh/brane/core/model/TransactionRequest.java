...
public record TransactionRequest(
     ...
     */
    public sh.brane.core.tx.UnsignedTransaction toUnsignedTransaction(final long chainId) {
        if (from == null) {
        ...
        if (isEip1559) {
            ...
            return new sh.brane.core.tx.Eip1559Transaction(
                    chainId,
                    nonce,
            ...
            return new sh.brane.core.tx.LegacyTransaction(
                    nonce,
                    gasPrice,
                    gasLimit,
                    to,
