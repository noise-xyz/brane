 ...
 * should use its own builder instance. The {@link #build()} and {@link #build(io.brane.core.crypto.Kzg)}
...
public final class Eip4844Builder {
     ...
     *
     * <p>The data will be encoded into blobs when {@link #build(io.brane.core.crypto.Kzg)}
     ...
     */
    public BlobTransactionRequest build(final io.brane.core.crypto.Kzg kzg) {
        if (kzg == null) {
        ...
        BlobSidecar builtSidecar = io.brane.core.tx.SidecarBuilder.from(blobData).build(kzg);
