 ...
 */
package io.brane.internal.web3j.crypto.transaction.type;
...
import io.brane.internal.web3j.crypto.AuthorizationTuple;
import io.brane.internal.web3j.crypto.Sign;
...
public class Transaction7702 extends Transaction1559 implements ITransaction {
    ...
    public List<RlpType> asRlpValues(final Sign.SignatureData signatureData) {
        ...
        if (signatureData != null) {
            ...
            values.add(
                    RlpString.create(
                            io.brane.internal.web3j.utils.Bytes.trimLeadingZeroes(signatureData.getR())));
            values.add(
                    RlpString.create(
                            io.brane.internal.web3j.utils.Bytes.trimLeadingZeroes(signatureData.getS())));
        }
